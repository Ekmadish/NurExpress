...
public class HisActivity extends Activity {
    ...
    private void deleteDataone(String nostr,String copstr) {
        ...
        Toast.makeText(this, "This record has been cleared!", Toast.LENGTH_SHORT).show();
    }

    // 数据库删除
    private void deleteData() {
        int count = mDatabase.delete(DBHelper.TABLE_NAME,null,null);
        Toast.makeText(this, " Historical record has been erased： "+count+" ！", Toast.LENGTH_SHORT).show();
    }
    ...
    private void queryData() {
        ...
        if (cursor != null) {
            ...
            myAdapter.add(new ListCellData("Clear all search records",""));
        }
    }
}
